...
class Gun(object):
    ...
    Attributes:
        ...
        bulletsInMagazine: int
            The bullets the gun has

        canFire: bool
            If the gun can fired
...
class MissileLauncher(Gun):
    """ Base weapon for the Missile Launcher
...
class FlameThrower(Gun):
    """ Base weapon for the flamethrower
...
class LaserCannon(Gun):
    """ A class representing a Laser Cannon
...
class LightningStaff(Gun):
    """ A class representing a Lightning Staff
...
class Lightning(Projectile):
    """ A class representing abeam of lightning
...
class Icicle(EnemyProjectile):
    """ A class representing an icicle
...
def drawWeaponUnlock():
    ...
    drawInstruction(weaponUnlockMessage, weaponUnlockLettersToRender // 2)
